...
const rawData = fs.readFileSync(path.join(__dirname, 'raw_luxury.txt'), 'utf-8');
...
fs.writeFileSync(path.join(__dirname, 'luxury.json'), JSON.stringify(cruises, null, 2));
console.log('Parsed', cruises.length, 'luxury cruises');
