...
const rawData = fs.readFileSync(path.join(__dirname, 'raw_deluxe.txt'), 'utf-8');
...
fs.writeFileSync(path.join(__dirname, 'deluxe.json'), JSON.stringify(cruises, null, 2));
console.log('Parsed', cruises.length, 'deluxe cruises');
