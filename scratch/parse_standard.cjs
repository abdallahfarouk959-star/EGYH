...
const inputFile = path.join(__dirname, 'raw_standard.txt');
const outputFile = path.join(__dirname, 'standard.json');
...
fs.writeFileSync(outputFile, JSON.stringify(cruises, null, 2));
console.log('Parsed', cruises.length, 'standard cruises');
