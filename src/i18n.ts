  ...
  en: {
    translation: {
      nav: {
        ...
        all_nile_cruises: "All Nile Cruises",
        luxury_cruises: "Luxury Cruises",
        ultra_deluxe_cruises: "Ultra Deluxe Cruises",
        deluxe_cruises: "Deluxe Cruises",
        standard_cruises: "Standard Cruises",
        lake_nasser_cruises: "Lake Nasser Cruises",
        cruise_by_felucca: "Cruise by Felucca",
        dahabiya_nile_cruise_boat: "Dahabiya Nile Cruise Boat",
        "6_nights": "6 Nights",
        "9_nights": "9 Nights",
        "11_nights": "11 Nights",
        "14_nights": "14 Nights",
      ...
      cruises_ui: {
        select_itinerary: "Select Your Itinerary",
        selected: "Selected",
        select: "Select",
        pricing_seasons: "Pricing Seasons",
        price_per_person: "* Price is per person",
        double_cabin: "Double Cabin:",
        single_cabin: "Single Cabin:",
        triple_cabin: "Triple Cabin:",
        itinerary_schedule: "Itinerary Schedule",
        children_policy: "Children Policy",
        book_your_cruise: "Book Your Cruise",
        direct_booking: "Direct booking with Egypt's #1 operator.",
        cruise_not_found: "Cruise not found",
        view_all_cruises: "View All Cruises",
        experience_journey: "Experience the ultimate journey on board",
        day: "Day",
        select_date: "Select Date",
        departs: "Departs:",
        cabins: "Cabins",
        cabin_singular: "Cabin",
        cabin_plural: "Cabins",
        adults: "Adults",
        adults_age: "(+12 years)",
        children: "Children",
        children_under_6: "(0 to 5.99 years)",
        children_6_12: "(6 to 11.99 years)",
        agree_terms_part1: "I agree to the ",
        terms_and_conditions: "Terms & Conditions",
        agree_terms_part2: ", Payment, and Cancellation Policies.",
        sending_request: "Sending Request...",
        request_sent: "Request sent! We will contact you shortly.",
        request_error: "Something went wrong. Please try again.",
        departures_only_on: "Departures are only available on",
      ...
      tours_ui: {
        ...
        pricing_tiers: "Pricing Options (Per Person)",
        prices_starting: "Starting From",
        per_person: "/ per person",
        book_request_now: "Book Request Now",
        no_packages: "No packages available in this category currently.",
        seasonal_supplements: "Seasonal Supplements",
        peak_season: "Peak Season",
        high_season: "High Season",
        booking_request: "Booking Request",
        your_full_name: "Your Full Name",
        desired_travel_date: "Desired Travel Date",
        number_of_travelers: "Number of Travelers",
        kids_0_6: "Kids (0-6)",
        kids_6_12: "Kids (6-12)",
        special_requests: "Special Requests / Notes",
        agree_booking_terms: "I agree to the terms of booking, privacy policy, and confirm that all data typed above is correct.",
        confirm_request: "Confirm & Request Booking",
        booking_success: "Your booking request was submitted successfully!",
        booking_error: "Something went wrong.",
        booking_connect_error: "Failed to connect to the server.",
        agree_required: "You must agree to the privacy policy to submit."
      },
      cruises_list: {
        hero_title: "Nile River Cruises",
        hero_desc: "Experience the heartbeat of Egypt. From legendary vessels to ultra-luxury cruises, discover your perfect journey.",
        all_cruises: "All Cruises",
        luxury: "Luxury",
        ultra_deluxe: "Ultra Deluxe",
        deluxe: "Deluxe",
        standard: "Standard",
        lake_nasser: "Lake Nasser Cruises",
        felucca: "Cruise by Felucca",
        dahabiya: "Dahabiya Nile Cruise Boat",
        cruises_suffix: "Cruises",
        filters: "Filters",
        category: "Category",
        ...
        no_cruises: "No cruises found",
        no_cruises_hint: "Try adjusting your filters to find what you're looking for.",
        various_durations: "Various Durations",
        nights_available: "Nights Available",
        starting_from: "Starting from",
        multiple_itineraries: "Aswan / Luxor (Multiple Itineraries)"
      }
    }
  },
  fr: {
    translation: {
      nav: {
        ...
        all_nile_cruises: "Toutes les croisières sur le Nil",
        luxury_cruises: "Croisières de luxe",
        ultra_deluxe_cruises: "Croisières ultra deluxe",
        deluxe_cruises: "Croisières deluxe",
        standard_cruises: "Croisières standard",
        lake_nasser_cruises: "Croisières sur le lac Nasser",
        cruise_by_felucca: "Croisière en felouque",
        dahabiya_nile_cruise_boat: "Bateau dahabiya sur le Nil",
        "6_nights": "6 Nuits",
        "9_nights": "9 Nuits",
        "11_nights": "11 Nuits",
        "14_nights": "14 Nuits",
      ...
      cruises_ui: {
        select_itinerary: "Sélectionnez votre itinéraire",
        selected: "Sélectionné",
        select: "Sélectionner",
        pricing_seasons: "Saisons de tarification",
        price_per_person: "* Le prix est par personne",
        double_cabin: "Cabine Double :",
        single_cabin: "Cabine Simple :",
        triple_cabin: "Cabine Triple :",
        itinerary_schedule: "Calendrier de l'itinéraire",
        children_policy: "Politique pour les enfants",
        book_your_cruise: "Réservez votre croisière",
        direct_booking: "Réservation directe avec le premier opérateur égyptien.",
        cruise_not_found: "Croisière introuvable",
        view_all_cruises: "Voir toutes les croisières",
        experience_journey: "Vivez le voyage ultime à bord de",
        day: "Jour",
        select_date: "Sélectionner une date",
        departs: "Départs :",
        cabins: "Cabines",
        cabin_singular: "Cabine",
        cabin_plural: "Cabines",
        adults: "Adultes",
        adults_age: "(+12 ans)",
        children: "Enfants",
        children_under_6: "(0 à 5,99 ans)",
        children_6_12: "(6 à 11,99 ans)",
        agree_terms_part1: "J'accepte les ",
        terms_and_conditions: "Conditions Générales",
        agree_terms_part2: ", le paiement et les politiques d'annulation.",
        sending_request: "Envoi de la demande...",
        request_sent: "Demande envoyée ! Nous vous contacterons sous peu.",
        request_error: "Une erreur s'est produite. Veuillez réessayer.",
        departures_only_on: "Les départs ne sont disponibles que le",
        no_matches_found: "Aucun résultat trouvé"
      },
      tours_ui: {
        included: "Ce qui est inclus",
        excluded: "Ce qui n'est pas inclus",
        overview: "Aperçu et points forts",
        itinerary: "Chronologie de l'itinéraire",
        pricing_tiers: "Options de tarification (par personne)",
        prices_starting: "À partir de",
        per_person: "/ par personne",
        book_request_now: "Demander une réservation",
        no_packages: "Aucun forfait disponible dans cette catégorie actuellement.",
        seasonal_supplements: "Suppléments saisonniers",
        peak_season: "Haute saison",
        high_season: "Saison intermédiaire",
        booking_request: "Demande de réservation",
        your_full_name: "Votre nom complet",
        desired_travel_date: "Date de voyage souhaitée",
        number_of_travelers: "Nombre de voyageurs",
        kids_0_6: "Enfants (0-6)",
        kids_6_12: "Enfants (6-12)",
        special_requests: "Demandes spéciales / Notes",
        agree_booking_terms: "J'accepte les conditions de réservation, la politique de confidentialité, et confirme que toutes les données saisies ci-dessus sont correctes.",
        confirm_request: "Confirmer et demander la réservation",
        booking_success: "Votre demande de réservation a été soumise avec succès !",
        booking_error: "Une erreur s'est produite.",
        booking_connect_error: "Impossible de se connecter au serveur.",
        agree_required: "Vous devez accepter la politique de confidentialité pour soumettre."
      },
      cruises_list: {
        hero_title: "Croisières sur le Nil",
        hero_desc: "Découvrez le cœur battant de l'Égypte. Des navires légendaires aux croisières ultra-luxueuses, trouvez votre voyage parfait.",
        all_cruises: "Toutes les croisières",
        luxury: "Luxe",
        ultra_deluxe: "Ultra Deluxe",
        deluxe: "Deluxe",
        standard: "Standard",
        lake_nasser: "Croisières sur le lac Nasser",
        felucca: "Croisière en felouque",
        dahabiya: "Bateau dahabiya sur le Nil",
        cruises_suffix: "Croisières",
        filters: "Filtres",
        category: "Catégorie",
        price_range: "Fourchette de prix (USD)",
        ...
        no_cruises: "Aucune croisière trouvée",
        no_cruises_hint: "Essayez d'ajuster vos filtres pour trouver ce que vous cherchez.",
        various_durations: "Durées variées",
        nights_available: "Nuits disponibles",
        starting_from: "À partir de",
        multiple_itineraries: "Assouan / Louxor (Itinéraires multiples)"
      }
    }
  }
};
