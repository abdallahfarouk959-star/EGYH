...
import { Clock, CheckCircle, X, Users, MessageSquare, ChevronLeft, Calendar, DollarSign, Info, AlertTriangle } from 'lucide-react';
              ...
              {singleTourDetail.pricingPolicy && (
                <div className="mt-8 bg-slate-50 border border-slate-200 rounded-3xl p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-6 border-b border-slate-200 pb-4">
                    ...
                    <h3 className="text-lg font-bold text-slate-900">Seasonal Supplements</h3>
                  </div>
